...
require (
	...
	github.com/scylladb/scylla-manager/v3/pkg/managerclient a46b9332650a
	github.com/scylladb/scylla-manager/v3/pkg/util a46b9332650a
	github.com/scylladb/scylla-manager/v3/swagger a46b9332650a
...
replace (
	github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring => github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring v0.88.0
	github.com/prometheus-operator/prometheus-operator/pkg/client => github.com/prometheus-operator/prometheus-operator/pkg/client v0.88.0
)
