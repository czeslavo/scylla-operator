...
require (
	...
	github.com/scylladb/scylla-manager/v3/pkg/managerclient 4618ae4ab7b7
	github.com/scylladb/scylla-manager/v3/pkg/util 4618ae4ab7b7
	github.com/scylladb/scylla-manager/v3/swagger 4618ae4ab7b7
...
replace (
	github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring => github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring v0.88.1
	github.com/prometheus-operator/prometheus-operator/pkg/client => github.com/prometheus-operator/prometheus-operator/pkg/client v0.88.1
)
